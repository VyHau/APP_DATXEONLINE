...
public class ColorMain {
        public static Color colorPrimary = new Color(23, 107, 230);
        public static Color colorSecondary = new Color(19, 166, 221);
        public static Color colorThird = new Color(135, 206, 250);
        public static Color inforPanel = new Color(240, 240, 240);
        public static Color colorRed = Color.RED;
        public static Color colorBlueBlack1 = new Color(41, 128, 185);// xanh đậm đen
        public static Color colorBlueBlack2 = new Color(52, 152, 219);
