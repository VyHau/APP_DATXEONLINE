...
import me.myproject.BUSINESSLOGIC.DangKyDriverBSL;
...
public class DangKyDriverView extends JPanel implements ActionListener, InputMethodListener {
    private final DangKyDriverBSL bussiness;
    public JTextField tfdName, tfdEmail, tfdPhone, tfdBirth;
    public JPasswordField tfdPass;
    public JButton btnRegister, btnBack;

    public DangKyDriverView() {
        bussiness = new DangKyDriverBSL();
        init();
    }
    ...
    private void init() {
        ...
        JPanel panelCenter = new JPanel(new GridLayout(6, 2, 0, 10));
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (action.equals("Đăng ký")) {
            ...
            if (frame != null) {
                frame.setContentPane(new DangKyUserView()); // Giả sử có RegisterUserPanel
                frame.revalidate();
                frame.repaint();
            }
        }
