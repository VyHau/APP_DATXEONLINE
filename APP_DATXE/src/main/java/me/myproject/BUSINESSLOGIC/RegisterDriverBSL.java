...
public class RegisterDriverBSL {
    ...
    public String xuLyDangKy(String name, String email, String phone, String birth, String password) {
        ...
        if (tinhTuoi(birth) < 18) return "Bạn phải trên 18 tuổi.";
