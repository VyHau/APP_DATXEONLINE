...
public class RegisterDriverGUI1 extends JPanel implements ActionListener, InputMethodListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (action.equals("Đăng ký")) {
            ...
            if (frame != null) {
                frame.setContentPane(new RegisterUserGUI1()); // Giả sử có RegisterUserPanel
                frame.revalidate();
                frame.repaint();
            }
        }
